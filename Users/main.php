...
<nav class="navbar navbar-expand-lg navbar-light bg-dark">
    ...
    <div class="container">
        ...
        <div class="d-flex align-items-center">
            <h6>Hey, <?php echo $_SESSION['email']; ?>!</h6>
            <button onclick= "document.location = 'logout.php'" idn_to_ascii class="btn btn-primary px-2 me-2">
            Logout
          </button>
        ...
        <div class="table-responsive">
            ...
            <?php
                ...
                <tr>
                        ...
                        <td><a href="main.php?action=delete&id=<?php echo $value["product_id"]; ?>"><span class="text-danger">Remove Item</span></a></td>
                </tr>
                <?php
